...
const DashAgent = () => {
  ...
  if (isError) {
    toast.error(t("fall"));
    return <div className="text-red-500 p-4">{t("fall")}</div>;
  }
  ...
  return (
    <div  dir="rtl" className="p-4 space-y-6 max-w-md mx-auto">
      ...
      <Card className="flex items-center  gap-4 p-4 border-red-600  border-s-4 ">
        ...
        <div>
          <p className=" text-slate-800 text-lg">{t("unpaid")}</p>
      ...
      <Card className="flex items-center justify-between p-4 border-green-600 border-s-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-slate-800 text-lg">{t("balance")}</p>
        ...
        <div className="space-y-4">
          ...
          {logsLoading ? (
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              <h3 className="font-medium text-gray-800">{t("balanceLogs")}</h3>
              {balanceLogs.map((log) => (
                <div
                  key={log.id}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between items-center mt-1">
                        ...
                        <span className="text-xs text-blue-600">
                          {t("performedBy")}: {log.performedByName}
                        </span>
                      </div>
